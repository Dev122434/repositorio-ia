...
# --- Prueba ---
#print(ejecutar_con_memoria("Hola, soy Marcos."))
#print(ejecutar_con_memoria("¿Recuerdas cómo me llamo?"))
#print(ejecutar_con_memoria("¿Qué hablamos antes?"))

print(ejecutar_con_memoria('Recuerdas como me llamo'))
print(ejecutar_con_memoria('De que hablamos en nuestra ultima conversacion'))
